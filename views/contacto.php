    ...
    <div class="col-12 col-xl-5 pt-3">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputNombreDisco" required>
                    </div>
                    <div class="mb-3">
                        <label for="inputNombreArtista" class="form-label inputContacto">Nombre del artista/banda*</label>
                        <input type="text" class="form-control" id="inputNombreArtista" required>
                    </div>
                    
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="newsletterCheck" required>
